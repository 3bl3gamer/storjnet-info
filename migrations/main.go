...
func main() {
	flag.Usage = usage
	dbname := flag.String("dbname", "storjnet_db", "database name")
	flag.Parse()

	db := pg.Connect(&pg.Options{User: "storjnet", Password: "storj", Database: *dbname})
	db.AddQueryHook(dbLogger{})

	migrations.SetTableName("storjnet.gopg_migrations")
