...
export function MapControlLayer(map) {
...
export function MapControlHintLayer(controlText, twoFingersText) {
	...
	this.onregister = function (map) {
		map.div.appendChild(this.elem)
	}
	this.onunregister = function (map) {
		map.div.removeChild(this.elem)
	}
	this.update = function (map) {}
	this.redraw = function (map) {}
